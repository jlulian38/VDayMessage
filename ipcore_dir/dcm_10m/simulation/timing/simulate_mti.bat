...
vlog -work work dcm_10m_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax dcm_10m_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.dcm_10m_tb work.glbl
